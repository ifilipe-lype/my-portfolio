          ...
          >
            <div className="pb-8 px-4  lg:p-8 shadow-lg bg-gray-900 bg-opacity-60 text-white md:rounded-l-none h-full rounded-md">
              <motion.div
                ...
                style={{
                  backgroundImage:
                    'url(https://res.cloudinary.com/dvjnagd3i/image/upload/v1625650294/portfolio_assets/avatar_vabox3.jpg)',
                }}
              ...
              <div className="mt-4">
                <h3 className="mb-4 text-sm md:text-base text-center md:text-left">
                  Reach me by
                </h3>
